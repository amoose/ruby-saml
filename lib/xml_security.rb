...
module XMLSecurity
  ...
  class Document < BaseDocument
    ...
    def sign_document(private_key, certificate, signature_method = SHA1, digest_method = SHA1)
      ...
      # transforms_element.add_element("ec:InclusiveNamespaces", {"xmlns" => C14N, "PrefixList" => INC_PREFIX_LIST})
  ...
  class SignedDocument < BaseDocument
    ...
    def validate_document(idp_cert_fingerprint, soft = true)
      ...
      normalized_fingerprint = idp_cert_fingerprint.gsub(/[^a-zA-Z0-9]/,"").downcase
      ...
      if fingerprint != normalized_fingerprint
        if soft
          ...
          raise OneLogin::RubySaml::ValidationError.new("Fingerprint mismatch")
        end
      end
